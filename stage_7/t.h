...
struct MethodListNode *MLInitNode(char *, int, int, struct TypeTable *, struct ParamNode *);
...
void GSTChangeTypeClass(struct AST_Node *, struct TypeTable *, struct ClassTable *);
void GSTPrint();
